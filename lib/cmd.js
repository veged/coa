...
exports.Cmd = Cmd = (function() {
  ...
  */
  ...
  Cmd.prototype._do = function(input) {
    return Q.when(input, __bind(function(input) {
      var cmd;
      cmd = input.cmd;
      return [this._checkRequired].concat(cmd._act || []).reduce(function(res, act) {
  ...
  */
  Cmd.prototype.run = function(argv) {
    ...
    cb = __bind(function(code) {
      return __bind(function(res) {
        var _ref, _ref2;
        if (res) {
  ...
  */
  Cmd.prototype.invoke = function(cmds, opts, args) {
    ...
    return Q.when(this._parseCmd(cmds), __bind(function(p) {
      if (p.argv.length) {
