...
exports.Cmd = Cmd = (function() {
  ...
  */
  ...
  Cmd.prototype._parseArr = function(argv, opts, args) {
    var arg, cmd, hitOnly, i, m, nonParsed, nonParsedArgs, nonParsedOpts, opt, _i, _len, _ref;
    if (opts == null) {
      opts = {};
    }
    if (args == null) {
  ...
  */
  Cmd.prototype.run = function(argv) {
    ...
    this._do(argv, function(res) {
      var _ref;
      return this._exit(res.toString(), (_ref = res.exitCode) != null ? _ref : 0);
    }, function(res) {
      var _ref;
      return this._exit(res.toString(), (_ref = res.exitCode) != null ? _ref : 1);
    });
    return this;
  };
  /**
