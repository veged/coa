  ...
  */
  ...
  exports.Cmd = Cmd = (function() {
    ...
    */
    ...
    Cmd.prototype.helpful = function(cb) {
    ...
    */
    ...
    Cmd.prototype.usage = function() {
      ...
      if (this._cmds.length) {
        res.push(['', '', this._fullName(), '<command>', '[options]', '[<args>...]'].join(' '));
      }
      if (this._opts.length + this._args.length) {
        res.push(['', '', this._fullName(), '[options]', '[<args>...]'].join(' '));
      }
      if (this._usages(this._cmds, 'Commands')) {
        res.push(this._usages(this._cmds, 'Commands'));
      }
      if (this._usages(this._args, 'Arguments')) {
        res.push(this._usages(this._args, 'Arguments'));
      }
      if (this._usages(this._opts, 'Options')) {
        res.push(this._usages(this._opts, 'Options'));
      }
      return res.join('\n');
    };
